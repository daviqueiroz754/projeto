...
<div class="row">
            <div class="col-md-8">
            <h4  class="my-0 font-weight-normal">Meus pedidos</h4>
</div>
...
<script type="text/javascript">
              ...
              function freteCalcula(){
                ...
                document.getElementById("frete").innerHTML = "<h3 style='color:green'>FRETE GRÁTIS</h3>";
...
<tr>
                        ...
                        <?php if($total > 99){
?>
                        <td> <h3 id="frete" style="float:right; color: green">Frete:</h3></td>
<?php
                        }
                          ?>
